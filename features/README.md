# Acceptance specifications (Gherkin)
...
| [`kitchen/kitchen-results-admin.feature`](kitchen/kitchen-results-admin.feature) | **APPROVED PRODUCT TARGET** (admin authorization `@pending`) |

See [`../docs/README.md`](../docs/README.md) for the documentation status legend.
