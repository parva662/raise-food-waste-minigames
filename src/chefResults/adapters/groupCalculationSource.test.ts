    ...
    const resolution = resolveCloseoutChefForecastFromInputCollections(
      {
        [KITCHEN_GROUP_INPUT_COLLECTION_KEY]: {
          [KITCHEN_GROUP_ACTIVITIES_REQUEST_KEY]: [
            null,
            'invalid',
            { template: { slug: 'studentLunchCheckin' } },
          ],
        },
      },
      serviceDate,
  ...
  it('keeps the recorder identity on the latest wasteMeasurement for a service date', () => {
    const older = wasteMeasurementActivity({
      ...
      properties: [
        ...
        { template: { slug: 'mainItemId' }, value: { value: 'meatballs' } },
        { template: { slug: 'preparedMainQuantity' }, value: { value: 100 } },
        { template: { slug: 'vegetarianItemId' }, value: { value: 'quorn' } },
        { template: { slug: 'preparedVegetarianQuantity' }, value: { value: 50 } },
        { template: { slug: 'soupItemId' }, value: { value: 'pumpkin-soup' } },
        { template: { slug: 'preparedSoupQuantity' }, value: { value: 38 } },
        { template: { slug: 'dessertItemId' }, value: { value: 'apple-compote' } },
        { template: { slug: 'preparedDessertQuantity' }, value: { value: 30 } },
        { template: { slug: 'overproductionMeatKg' }, value: { value: 0.5 } },
        { template: { slug: 'overproductionVegetarianKg' }, value: { value: 0.2 } },
        { template: { slug: 'overproductionSoupKg' }, value: { value: 0.3 } },
        { template: { slug: 'overproductionDessertKg' }, value: { value: 0.1 } },
        { template: { slug: 'submittedAt' }, value: { value: '2026-07-29T12:00:00.000Z' } },
      ],
    });
    ...
    const inputCollections = {
      [KITCHEN_GROUP_INPUT_COLLECTION_KEY]: {
        [KITCHEN_GROUP_ACTIVITIES_REQUEST_KEY]: [
          buildAnonymizedChefForecastActivity({ targetDate: serviceDate }),
          wasteMeasurementActivity(),
          { id: 'bad-forecast', template: { slug: 'chefForecast' }, properties: [] },
        ],
      },
    };
